...
<template>
  <div ref="dropdownMenuContainer">
    <input 
      ...
      class="w-60 origin-top-left outline-none focus:ring-2 placeholder-gray-400 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500/50 focus:border-blue-500 focus:bg-transparent p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      autocomplete="off" 
      @focus="onFocus"
      @blur="onBlur"
      />
    <span 
      v-else
      class="w-60 text-gray-400 cursor-pointer origin-top-left border border-gray-300 text-sm rounded-lg p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
